            ...
            @foreach ($productVariantOptions as $productVariantOption)
                <tr wire:key="option-row-{{ $productVariantOption->id }}"
                    ...
                    <td>
                        <button class="btn btn-sm btn-outline-secondary collapsed" type="button"
                            ...
                            <span
                                class="badge bg-secondary">{{ count($productVariantOption->productVariantOptionDetails) }}</span>
                        </button>
                    </td>
                    <td>
                        @include('admin.product-variant.product-variant-options.edit-modal', [
                ...
                <tr wire:key="option-details-row-{{ $productVariantOption->id }}"
                    ...
                    <td colspan="4" class="p-0">
                        <div class="p-2">
                            @include(
                                'admin.product-variant.product-variant-options.product-variant-option-details.store-modal',
                                ['productVariantOption' => $productVariantOption]
                            )
