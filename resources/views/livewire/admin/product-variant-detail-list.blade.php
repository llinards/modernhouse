            ...
            <tbody wire:sortable="updateDetailOrder">
                @foreach ($details as $detail)
                    <tr wire:key="detail-{{ $detail->id }}" wire:sortable.item="{{ $detail->id }}">
                        ...
                        <td>
                            <img width="25"
                                src="{{ asset('storage/icons/product-variant-detail-icons/' . $detail->icon . '.svg') }}"
                                alt="" class="me-2">
                            {{ $detail->name }}
                        </td>
                        <td>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="detail-hasThis"
                                    wire:model="form.hasThis">
                                    ...
                                    <div class="position-relative">
                                        <label for="icon-{{ $iconItem->id }}"
                                            ...
                                            <input class="d-none" type="radio"
                                                ...
                                                id="icon-{{ $iconItem->id }}" wire:model.live="form.icon">
                                            <img width="40"
                                                src="{{ asset('storage/icons/product-variant-detail-icons/' . $iconItem->name) }}"
                                                alt="">
                                        </label>
                                        <button type="button"
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="file" id="detail-new-icon"
                                wire:model="form.newIcon" accept=".svg">
