    ...
    <div class="row justify-content-center py-4">
      <div class="col-lg-8 col-md-10">
        <div class="text-center">
          ...
          <h4 class="mt-4 mb-2">Paldies visiem apmeklētājiem!<br/>Reģistrācija pasākumam ir slēgta.<br/>Tiekāmies
            nākamajos
            pasākumos!
          </h4>
        </div>
          ...
          <form wire:submit="register">
            ...
            <div class="mb-3">
              ...
              <select class="form-select" wire:model="reason" required name="reason">
                ...
                <option value="Vēlos redzēt būvniecības procesu dzīvajā">Vēlos redzēt būvniecības procesu dzīvajā
                </option>
