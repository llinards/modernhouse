  ...
  <div id="landing-page" class="position-relative non-fixed">
    <section id="introduction" class="full-height-section d-flex flex-column justify-content-between"
      ...
      <div class="px-2">
        ...
        <h2 class="text-center text-white text-uppercase mt-0 mb-4">“MODERN HOUSE MĀJU MARŠRUTS 2025”</h2>
      </div>
              ...
              <div class="col-12">
                <ul class="list-unstyled">
                  <li class="mb-2 mb-lg-4">
                    <div>
                      <h5 class="mb-2">1. Pilnībā pabeigta privātmāja, ko vari iegādāties jau šodien</h5>
                      <p>Pilnībā pabeigta un iekārtota privātmāja – gatava iegādei jau šodien!</p>
                    </div>
                  </li>
                  <li class="mb-2 mb-lg-4">
                    <div>
                      <h5 class="mb-2">2. Iespēja satikt un iepazīties ar MODERN HOUSE komandu</h5>
                      <p>Iespēja uzdot arī tehniskus jautājumus projektu vadītājiem un citiem MODERN HOUSE
                        speciālistiem.</p>
                    </div>
                  </li>
                  <li class="mb-2 mb-lg-4">
