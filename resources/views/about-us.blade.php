      ...
      <div class="mt-4">
        <div class="row">
          ...
          <div class="col-lg-6 d-flex justify-content-center align-items-start flex-column mt-lg-0 mt-4">
            ...
            <p class="pb-2">MODERN HOUSE realizē projektus, kuri ir veidoti ar kvalitāti, estētiku, komfortu un ilgtspējību.
              Projektos izvēlamies strādāt tikai ar labākajiem materiāliem un tieši tāpēc mēs arī vēlamies piesaistīt
              klientus, kuriem ir svarīga kvalitāte.</p>
            <p class="pb-2">Mēs radām ilgtspējīgu un mūsdienīgu koka karkasu māju konceptu. MODERN HOUSE ir atvērti jebkuram
              investīciju un sadarbības piedāvājumam.</p>
            <p>Mājas koncepti tiek izstrādāti atbilstoši tam, lai ēka iegūtu A+ energoefektivitātes pakāpi, kas pozitīvi
              atsaucas uz zemām ikmēneša izmaksām.</p>
          </div>
        </div>
        <div class="row mt-5">
          <div class="col-lg-6 d-flex justify-content-center align-items-start flex-column mt-lg-0 mt-4">
            <h2 class="fw-bold title mb-2">Mūsu komanda</h2>
            <p>Mūsu komandā ir pārliecinoši cilvēki un savas jomas profesionāļi, kuri izvēlēsies labākos risinājumus un
              materiālus. Kontrolējam kvalitāti katrā celtniecības posmā un tieši tāpēc nodrošinām katram klientam
              iespēju iepazīties ar ražošanas procesu tepat Siguldā, kā arī iespēju redzēt Jūsu iecerētās sapņu mājas
              būvniecības procesu.
            </p>
          </div>
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-6 d-flex justify-content-center align-items-start flex-column mt-lg-0 mt-4">
            ...
            <p>Mūsu dizainam raksturīgs ir dabiskums, kas iekļauj koksni un dabīgu gaismu. Tieši tāpēc mūsu mājas ir ar
              lieliem logiem, kas visas dienas garumā nodrošina labu apgaismojumu.
            </p>
          </div>
        </div>
        <div class="row mt-5">
          <div class="col-lg-6 d-flex justify-content-center align-items-start flex-column ceo-quot">
            <h5 class="fw-bold mb-2">„Mēs sevi definējām kā uzņēmumu, kura pamatā ir profesionāla ražošanas un montāžas
              pieeja.”</h5>
            <p>Helvijs Ervalds</p>
